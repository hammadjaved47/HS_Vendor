...
class UpdateProductBody extends StatefulWidget {
  final String id;
  UpdateProductBody({Key key, @required this.id});
  @override
  _UpdateProductBodyState createState() => _UpdateProductBodyState();
}
...
//    var jsonResponse2 = jsonResponse['status'];
    var response = await http.post("http://sub.dev.healthsolutions.com.pk/public/api/updateproduct/${widget.id}", body: data);
